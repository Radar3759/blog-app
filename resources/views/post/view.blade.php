...
<x-app-layout>
        ...
        <section class="w-full md:w-2/3 flex flex-col items-center px-3">
            ...
            <article class="flex flex-col shadow my-4">
                ...
                @endforeach
                <h1 href="#" class="text-3xl font-bold hover:text-gray-700 pb-4">
                    {{$post->title}}
                </h1>
            ...
            <div class="w-full flex pt-6">
                <div class='w-1/2'>
                    ...
                    @if($prev)
                        <a href="{{route('view', $prev)}}" class="block 2-full bg-white shadow hover:shadow-md text-left p-6">
                ...
                <div class='w-1/2'>
                <a href="{{route('view', $next)}}" class="block 2-full bg-white shadow hover:shadow-md text-right p-6">
